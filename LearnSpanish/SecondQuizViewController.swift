...
class SecondQuizViewController: UIViewController ,GADBannerViewDelegate{
    ...
    override func viewDidLoad() {
        ...
        {
            self.topLabel.text = "Quiz-" + MainCollectionViewController.staticVal.labelsArray[MainCollectionViewController.staticVal.mainIndex]
    ...
    func questionIndex()
    {
        ...
        {
            audio = try! AVAudioPlayer(contentsOf: NSURL(fileURLWithPath: Bundle.main.path(forResource: mp3Array2[randomNumber], ofType: "mp3")!) as URL)
        }
